...
void controller::update() {
	...
	_controller_map["velocity_x"] = vx * ini_parser::instance().setting<float>("velocity_coeff");;
	_controller_map["velocity_y"] = vy * ini_parser::instance().setting<float>("velocity_coeff");
